...
export default function Lecon1({ onNext }: LeconProps) {
  return (
      ...
      <div className="max-w-2xl w-full bg-gray-800/50 rounded-2xl p-8 border border-gray-700">
        <div className="text-center">
          <div className="inline-block px-4 py-1 bg-blue-600/20 rounded-full mb-4">
            <span className="text-blue-400 text-sm font-medium">Module A - Chapitre 1</span>
          </div>
          <h1 className="text-4xl font-bold text-white mb-2">Leçon 1</h1>
          <p className="text-gray-400 mt-4">Contenu pédagogique de la leçon</p>
          
          <div className="mt-8 p-6 bg-gray-700/30 rounded-xl text-left">
            <p className="text-gray-300 leading-relaxed">
              Bienvenue dans la première leçon du Chapitre 1. Cette leçon vous introduira aux concepts fondamentaux.
            </p>
          </div>
